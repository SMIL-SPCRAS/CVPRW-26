...
DEFAULT_CONFIG = Path('make_va_chunks.yaml')
ACTIVE_POOL = None
...
def process_single_video(
    ...
    output_dir = output_root / 'Chunk' / subset_name / name_file
...
def process_subset(
    ...
    chunks_dir = output_root / 'Chunk' / subset_name
    ...
    df_full.to_csv(output_root / 'Chunk' / f'{subset_name}_full.csv', index=False)
    df_segment.to_csv(output_root / 'Chunk' / f'{subset_name}_segment.csv', index=False)
